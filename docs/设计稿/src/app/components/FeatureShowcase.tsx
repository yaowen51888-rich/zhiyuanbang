...
const features = [
  {
    icon: School,
    title: "学校查询",
    desc: "按省份、985/211、类型筛选高校，一键查看历年分数线与位次。",
    tint: "#2A9D8F",
    bg: "#E6F4EF",
    tag: "海量数据",
  },
  {
    icon: Target,
    title: "智能推荐",
    desc: "基于位次法的「冲稳保」三档方案，匹配录取概率与就业前景。",
    tint: "#F4A261",
    bg: "#FCEEDA",
    tag: "AI 算法",
    highlight: true,
  },
  {
    icon: ClipboardList,
    title: "模拟填报",
    desc: "拖拽排序你的志愿表，本地保存，多方案对比，随时调整。",
    tint: "#5BB89A",
    bg: "#E9F5EE",
    tag: "可视化",
  },
  {
    icon: BookOpen,
    title: "专业百科",
    desc: "740+ 专业详解，课程设置、就业方向、薪资数据一目了然。",
    tint: "#88B7AC",
    bg: "#EBF3F1",
  },
  {
    icon: LineChart,
    title: "位次分析",
    desc: "三年位次曲线，识别院校招生波动，避开「大小年」陷阱。",
    tint: "#2A6F66",
    bg: "#E1EDE9",
  },
  {
    icon: Compass,
    title: "城市指南",
    desc: "结合城市发展、生活成本与气候，找到真正适合你的求学之地。",
    tint: "#9FB89A",
    bg: "#ECF1E8",
  },
];
        ...
        {features.map((f, i) => {
          ...
          return (
            ...
            >
              ...
              <h3
                className="mt-6"
                style={{ fontSize: "1.25rem", fontWeight: 600, color: f.highlight ? "#fff" : "#16332C" }}
              >
                {f.title}
              </h3>
              <p
                className="mt-2 leading-relaxed"
                style={{ color: f.highlight ? "rgba(255,255,255,0.75)" : "#5A6B66", fontSize: "0.9375rem" }}
              >
                {f.desc}
              </p>
              <div
                className="mt-6 inline-flex items-center gap-1 text-sm transition-all"
                style={{ color: f.highlight ? "#FFE7C2" : f.tint }}
              >
                了解更多
