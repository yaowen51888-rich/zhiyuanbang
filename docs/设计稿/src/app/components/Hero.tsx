...
export function Hero() {
  ...
  const goRecommend = () => {
    navigate(`/recommend?province=${province}&subject=${subject}&score=${score}`);
  };
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-20 pb-28 grid lg:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <div className="mt-9 p-2 rounded-2xl bg-white border border-[#E3EDE7] shadow-xl shadow-[#2A9D8F]/5 max-w-xl">
            <div className="grid grid-cols-12 gap-2">
              <label className="col-span-3 px-3 py-3 rounded-xl bg-[#F2F8F5] block">
              ...
              <button
                onClick={goRecommend}
                className="col-span-3 rounded-xl bg-[#2A9D8F] hover:bg-[#23867A] transition-colors text-white inline-flex items-center justify-center gap-1.5 shadow-md shadow-[#2A9D8F]/30"
              >
          ...
          <div className="mt-6 flex items-center gap-6 text-xs text-[#6B7F7A]">
            ...
            <span className="text-[#B7C7C2]">·</span>
        ...
        <div className="lg:col-span-5 relative h-[520px] hidden lg:block">
          ...
          >
            <Link to="/university/swjtu" className="block">
              ...
              <div className="mt-1 text-xs text-[#6B7F7A] flex items-center gap-1">
                <MapPin className="h-3 w-3" /> 成都 · 211 · 综合类
              </div>
          ...
          >
            <Link to="/university/cuhk-sz" className="block">
          ...
          >
            <Link to="/university/xidian" className="block">
              <div className="flex items-center justify-between">
          ...
          <motion.div
            ...
            className="absolute -top-4 left-10 h-12 w-12 rounded-2xl bg-[#D9EAD0] flex items-center justify-center"
          >
            <svg viewBox="0 0 24 24" className="h-6 w-6 text-[#2A9D8F]" fill="currentColor">
              <path d="M17 4C9 4 5 10 5 16c0 2 .4 3.5.4 3.5S8 17 12 15s7-5 8-9c0-.7-.4-2-3-2z" />
            </svg>
          </motion.div>
        </div>
      </div>
